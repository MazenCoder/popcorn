import '../../packages/bottom_sheet/utils/modal_scroll_controller.dart';
...
class _ModalBottomSheet<T> extends StatefulWidget {
  ...
  final ModalBottomSheetRouteApp<T> route;
  final bool expanded;
  final bool bounce;
...
class ModalBottomSheetRouteApp<T> extends PageRoute<T> {
  ModalBottomSheetRouteApp({
    this.closeProgressThreshold,
  ...
  bool canTransitionTo(TransitionRoute<dynamic> nextRoute) =>
      nextRoute is ModalBottomSheetRouteApp;

  @override
  bool canTransitionFrom(TransitionRoute<dynamic> previousRoute) =>
      previousRoute is ModalBottomSheetRouteApp || previousRoute is PageRoute;
...
Future<T?> showCustomModalBottomSheet<T>({
  ...
  final result = await Navigator.of(context, rootNavigator: useRootNavigator)
      .push(ModalBottomSheetRouteApp<T>(
    builder: builder,
    bounce: bounce,
